...
1. https://chatgpt.com/c/68a84285-d660-832b-8017-637ca4d96db6 -> (create while creating the project , read if you have doubt or you can continue )
...
Account                       yourAccountAddress@gmail.com (Plan: Free)                                                                                    
Version                       3.26.0                                                                                                                    
Region                        India (in)                                                                                                                
Web Interface                 http://127.0.0.1:4040                                                                                                     
Forwarding                    https://ea7e199033cc66c.ngrok-free.app(it can be changed based on your setup) -> http://localhost:3000  

 https://ea7e199033cc66c.ngrok-free.app  ( Forwarding )-> It change everytime you run or restart  the ngrok .


 4. In index.js set "baseUrl"
  
  baseUrl =  https://ea7e199033cc66c.ngrok-free.app 
